<template>
  <Layout>
    <div class="wrapper pageOffset">
      ...
      <div class="col-sm-10 image animated">
        <videoRatio>
          <iframe
            class
            width="1100"
            height="500"
            src="https://www.youtube.com/embed/IUI3i_xu0GQ"
            frameborder="0"
      ...
      <next-case currentCase="Filterdome" />
    </div>
  </Layout>
</template>
...
import videoRatio from "../../atoms/videoRatio.vue";
